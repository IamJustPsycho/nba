...
class World(object):
    def __init__(self, carla_world, hud, args, aebs):
...
class AEBS(object):
    def __init__(self):
        ...
        self.mixer.init()
        self.warning_image = pygame.image.load("warning-sign.jpg")
        self.failure_warning_image = pygame.image.load("failure-warning-sign.png")
    ...
    def toggle_aebs(self):
        ...
        self.mixer.music.load("test.mp3")
    ...
    def test_aebs(self):
        ...
        try:
            #
            # Perform AEBS system test here     SELBE FUNKTIONEN WIE IN disable_on_failure
            # Auslagern in externe Funktion
            #
            print("AEBS system test successful.")
        except Exception as e:
            print("ERROR: AEBS system test failed with exception:", e)

    def activate_at_speed(self, speed):
        if speed >= 15:
            self.active = True
            print("AEBS system activated.")
        else:
            self.active = False
            print("AEBS system deactivated.")

    def disable_on_failure(self):
        try:
            #
            # Perform AEBS system test here     SELBE FUNKTIONEN WIE IN test_aebs
            # Auslagern in externe Funktion
            #
            print("AEBS system test successful.")
        except Exception as e:
    ...
    def system_failure_warning(self):
        ...
        screen.blit(self.failure_warning_image, (0, 0))
        pygame.display.flip()
...
def game_loop(args):
    ...
    try:
        ...
        aebs = AEBS()
        world = World(sim_world, hud, args, aebs)
